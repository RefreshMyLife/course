...
//styles
import { Card, TopBox, ContentBox, TagsBox, FooterBox } from './NoteCard.styles';
  ...
  return (
    <>
      ...
      <Card style={{ backgroundColor: color }}>
        <TopBox>
          <div className="noteCard__title" onClick={() => dispatch(readNote({ type, id }))}>
          ...
          <div className="noteCard__top-options">
            ...
            {type !== 'archive' && type !== 'trash' && (
              <NotesIconBox
                ...
                <BsFillPinFill style={{ color: isPinned && 'var(--primary-color)' }} />
              </NotesIconBox>
            )}
          </div>
        </TopBox>
        <ContentBox onClick={() => dispatch(readNote({ type, id }))}>{parse(func())}</ContentBox>
