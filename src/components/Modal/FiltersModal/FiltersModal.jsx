...
const FiltersModal = ({ handleFilter, handleClear, filter }) => {
  ...
  return (
    <FixedContainer>
      <Container>
        <DeleteBox onClick={() => dispatch(toggleFiltersModal(false))} className="filters__close">
          <FaTimes />
        </DeleteBox>
        <TopBox>
        ...
        <Box>
          ...
          <div className="filters__check">
            ...
            />
            <label htmlFor="low"> От низкого к высокгому</label>
          </div>
          <div className="filters__check">
            <input
              type="radio"
              ...
              onChange={(e) => handleFilter(e)}
            />
            <label htmlFor="high"> От высокого к низкому </label>
          </div>
          ...
          <Box>
            ...
            <div className="filters__check">
              <input
                ...
                onChange={(e) => handleFilter(e)}
              />
              <label htmlFor="new"> Сортировка по последнему </label>
            </div>
            <div className="filters__check">
              <input
                type="radio"
                ...
                onChange={(e) => handleFilter(e)}
              />
              <label htmlFor="create"> Сортировка по созданию</label>
            </div>
            ...
            <div className="filters__check">
              <input
                ...
                onChange={(e) => handleFilter(e)}
              />
              <label htmlFor="edit">Сортировка по редактированию</label>
            </div>
          </Box>
        </Box>
      </Container>
